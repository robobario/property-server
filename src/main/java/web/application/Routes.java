...
public class Routes {
    ...
    public static final String ENV_PUT_PROPERTY = ENV_NAME_TOKEN + "/" + PROPERTY_KEY_TOKEN + "/" + PROPERTY_VALUE_TOKEN;
    ...
    public static final String APP_PUT_PROPERTY = APP_NAME_TOKEN + "/" + PROPERTY_KEY_TOKEN + "/" + PROPERTY_VALUE_TOKEN;
    ...
    public static class EnvRouteBuilder{
        ...
        public String addSubEnvironmentTo(String envName, String newSubEnvName) {
            return ENVIRONMENT_HANDLER + "/" + ENV_CREATE_SUBENV.replace(ENV_NAME_TOKEN,envName).replace(SUB_ENV_NAME_TOKEN,newSubEnvName);
        }
        ...
        public String addApplicationTo(String environment, String appName) {
            return ENVIRONMENT_HANDLER + "/" + ENV_CREATE_APP.replace(ENV_NAME_TOKEN,environment).replace(APP_NAME_TOKEN,appName);
        }


        public String addPropertyTo(String envName, String propKey, String propValue) {
            return ENVIRONMENT_HANDLER + "/" + ENV_PUT_PROPERTY.replace(ENV_NAME_TOKEN,envName).replace(PROPERTY_KEY_TOKEN,propKey).replace(PROPERTY_VALUE_TOKEN,propValue);
        }


        public String removePropertyFrom(String envName, String propertyKey) {
            return ENVIRONMENT_HANDLER + "/" + ENV_DELETE_PROPERTY.replace(ENV_NAME_TOKEN,envName).replace(PROPERTY_KEY_TOKEN,propertyKey);
        }
    }
    ...
    public static class AppRouteBuilder{
        ...
        public String addProperty(String applicationName, String propertyKey, String propertyValue) {
            return APPLICATION_HANDLER + "/" + APP_PUT_PROPERTY.replace(APP_NAME_TOKEN,applicationName).replace(PROPERTY_KEY_TOKEN, propertyKey).replace(PROPERTY_VALUE_TOKEN,propertyValue);
        }


        public String removeProperty(String applicationName, String propertyKey) {
            return APPLICATION_HANDLER + "/" + APP_DELETE_PROPERTY.replace(APP_NAME_TOKEN,applicationName).replace(PROPERTY_KEY_TOKEN, propertyKey);
        }
    }
}
