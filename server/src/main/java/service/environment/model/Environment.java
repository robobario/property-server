...
public class Environment extends ChildPropertyContainer {
    ...
    public Environment createSubEnvironment(String subContainerName) {
        ...
        subEnvironments =
                ImmutableMap.<String, Environment>builder().putAll(subEnvironments).put(subContainerName, sub).build();
        return sub;
    }
    ...
    public Application createApplication(String applicationName) {
        ...
        applications =
                ImmutableMap.<String, Application>builder().putAll(applications).put(applicationName, application)
                        .build();
        return application;
    }
